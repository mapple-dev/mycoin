...
uint256 hashGenesisBlock("0xbc37713c2c5bb3f38d71b5018a567f5eb3d040b0b5c3dc5667f7bc48ff901a4b");
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // mycoin: 2 days
static const int64 nTargetSpacing = 20; // mycoin: 20 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "mycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6899535a0e1a3637acda51a308ffd017199e99bb18130c107fea763963671d21");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "To make the World delicius";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 3729750 ;

        if (fTestNet)
        {
            block.nTime    = 1369591342;
            block.nNonce   = 1025138;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa990fba83099db6e5b901aa00aab7f4afaa5e9d4f6e146f83ceb9c2892df3c4d"));
